...
function FacebookLogo() {
  return (
    <svg aria-hidden="true" focusable="false" viewBox="0 0 666.667 666.667">
...
function InstagramLogo({ idPrefix }: { idPrefix: string }) {
  const a = `${idPrefix}-a`;
  const b = `${idPrefix}-b`;
  const c = `${idPrefix}-c`;
  const d = `${idPrefix}-d`;
...
function TikTokLogo() {
  return (
    <svg aria-hidden="true" focusable="false" viewBox="0 0 352.28 398.67">
...
function SocialLogo({ idPrefix, link }: { idPrefix: string; link: SocialLink }) {
  if (link.icon === "facebook") {
    return <FacebookLogo />;
  }

  if (link.icon === "instagram") {
    return <InstagramLogo idPrefix={idPrefix} />;
  }
