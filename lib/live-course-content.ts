...
export const liveCourseContents: Record<LiveCourseId, LiveCourseContent> = {
  "dental-assisting-program": {
    ...
    bodyText: [
      ...
      `${classDateSentence("dental-assisting-program", "Class start dates")} The June 19, July 13, and September 4, 2026 starts are full; October 12, 2026 is the next available start.`,
  ...
  "infection-control": {
    ...
    bodyText: [
      ...
      `${classDateSentence("infection-control")} The June 6 and July 18, 2026 classes are full; August 1, 2026 is the next available date.`,
  ...
  "radiation-safety": {
    ...
    bodyText: [
      ...
      `${classDateSentence("radiation-safety")} The June 6 and July 18, 2026 classes are full; August 1, 2026 is the next available date.`,
  ...
  "coronal-polish": {
    ...
    bodyText: [
      ...
      `${classDateSentence("coronal-polish")} The June 20 and July 25, 2026 classes are full; August 8, 2026 is the next available date.`,
  ...
  sealants: {
    ...
    bodyText: [
      ...
      `${classDateSentence("sealants")} The June 20, July 25, and August 8, 2026 classes are full; September 12, 2026 is the next available date.`,
