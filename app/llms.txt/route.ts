...
- [Infection Control (IC189)](${SITE_URL}/infection-control): California Dental Board approved 8-hour course for unlicensed dental assistants. Since January 1, 2025 (Business and Professions Code section 1750(c)), every unlicensed dental assistant must complete it before duties with potential exposure to blood, saliva, or other potentially infectious materials, regardless of hire date; the employer is responsible for ensuring completion.
